---
type: SDK Example
title: SDK examples - Add Default Workspace
description: "Code samples in 9 languages for POST /restapi/v2/workspaces/{workspace-id}/default (addDefaultWorkspace)."
...
api:
  ...
  endpoint_doc: "/domains/workspace-management/workspace-preferences/add-default-workspace.md"
  languages:
    - cURL
    - "C#"
    - Go
...
Code samples for [Add Default Workspace](/domains/workspace-management/workspace-preferences/add-default-workspace.md) (`POST /restapi/v2/workspaces/{workspace-id}/default`). Replace the placeholder client ID, client secret, refresh token, organization ID, workspace ID and view ID values with your own. The SDK client construction pattern for each language is explained in [SDK clients](/foundations/sdk-clients.md).
...
public class Test {
    ...
    public static void main(String args[]) {
        ...
        try { tObj.addDefaultWorkspace(ac); }
...
<?php
    ...
    $test_obj = new Test();
    try { $test_obj->addDefaultWorkspace(); }
...
workspace.addDefault().then(function () {
    console.log('success');
...
- [Add Default Workspace](/domains/workspace-management/workspace-preferences/add-default-workspace.md) - full endpoint reference.
