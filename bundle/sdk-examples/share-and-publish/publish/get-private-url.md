---
type: SDK Example
title: SDK examples - Get Private URL
description: "Code samples in 9 languages for GET /restapi/v2/workspaces/{workspace-id}/views/{view-id}/publish/privatelink (getPrivateUrl)."
...
api:
  ...
  endpoint_doc: "/domains/share-and-publish/publish/get-private-url.md"
  languages:
    - cURL
    - "C#"
    - Go
...
sources:
  ...
  - id: endpoint-doc
    resource: "/domains/share-and-publish/publish/get-private-url.md"
    title: Endpoint reference - Get Private URL
generated:
...
Code samples for [Get Private URL](/domains/share-and-publish/publish/get-private-url.md) (`GET /restapi/v2/workspaces/{workspace-id}/views/{view-id}/publish/privatelink`). Replace the placeholder client ID, client secret, refresh token, organization ID, workspace ID and view ID values with your own. The SDK client construction pattern for each language is explained in [SDK clients](/foundations/sdk-clients.md).
...
```bash
curl "https://analyticsapi.zoho.com/restapi/v2/workspaces/35130000001055707/views/35130000001055717/publish/privatelink" -H 'ZANALYTICS-ORGID: <org-id>' -H 'Authorization: Zoho-oauthtoken <access_token>'
```
...
view.getPrivateUrl().then((result) => { console.log(result); }).catch((error) => { console.log(error); });
```
...
- [Get Private URL](/domains/share-and-publish/publish/get-private-url.md) - full endpoint reference.
