...
api:
  ...
  openapi:
    ...
    pointer: "#/paths/~1restapi~1v2~1workspaces~1{workspace-id}~1views~1{view-id}~1favorite/delete"
    config_schema: null
    response_schema: null
  sdk_examples: "/sdk-examples/views-management/view-preferences/remove-favorite-view.md"
sources:
  - id: openapi-spec
...
**DELETE `/restapi/v2/workspaces/{workspace-id}/views/{view-id}/favorite`** - Remove Favourite View (View Preferences / Views Management).

> This API has no CONFIG parameter. All inputs are provided via URL path parameters only.

From the OpenAPI specification:

Removes the specified view from the favorites list of the authenticated user.
...
| Attribute | Value |
|---|---|
| Operation ID | `removeFavoriteView` |
| HTTP method | DELETE |
...
| OpenAPI | [`views-management-grouped-api.json`](/references/openapi/views-management-grouped-api.json) - pointer `#/paths/~1restapi~1v2~1workspaces~1{workspace-id}~1views~1{view-id}~1favorite/delete` |
...
Code samples in cURL, C#, Go, Java, PHP, Python, Node.js, Ruby, Deluge (Zoho scripting) are in [SDK examples for Remove Favourite View](/sdk-examples/views-management/view-preferences/remove-favorite-view.md). Client construction is described in [SDK clients](/foundations/sdk-clients.md).
...
| [7301](/foundations/error-codes.md#error-7301) | 403 | User does not have permission to modify favourites for this view. | Ensure the user has at least Read Only permission on the view. |
...
- Other endpoints in this group: [Add Favourite View](/domains/views-management/view-preferences/add-favorite-view.md).
- [SDK examples](/sdk-examples/views-management/view-preferences/remove-favorite-view.md).
