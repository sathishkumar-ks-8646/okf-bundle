...
| `package_okf.py` | `bundle/`, `validate_okf.py` | `dist/analytics-okf/` (+ `.tar.gz` with `--tarball`) | Assembles the public repository layout: `README.md`, `llms.txt`, `LICENSE.md`, `CHANGELOG.md`, `okf/`, CI workflow. Preserves an existing `dist/analytics-okf/.git`. Never pushes. |
